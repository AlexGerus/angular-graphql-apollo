...
export type CountryFieldsFragment = { __typename?: 'Country', code: string, name: string };

export type CountriesListQueryVariables = Exact<{ [key: string]: never; }>;


export type CountriesListQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', code: string, name: string }> };
...
export const CountriesListDocument = gql`
  ...
  export class CountriesListGQL extends Apollo.Query<CountriesListQuery, CountriesListQueryVariables> {
    override document = CountriesListDocument;
